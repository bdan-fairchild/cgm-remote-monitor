...
daytoday.html = function html (client) {
  ...
  var ret =
    ...
    '<div id="daytodaycontrols" class="reportcontrols">' +
...
daytoday.prepareHtml = function daytodayPrepareHtml (sorteddaystoshow) {
  ...
  sorteddaystoshow.forEach(function eachDay (d) {
    $('#daytodaycharts').append($('<table><tr><td><div id="daytodaychart-' + d + '"></div></td><td><div id="daytodaystatchart-' + d + '" class="daytodaystatchart"></td></tr></table>'));
  });
};
